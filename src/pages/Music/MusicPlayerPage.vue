      ...
      <div class="row">
        <div class="col">
          <q-table
            ...
            <q-tr class="table-body" slot="body" slot-scope="props" :props="props" @click.native="playSong(props.row)">
    ...
    export default {
      ...
      data: () => ({
        ...
        columns: [
          ...
          {
            name: 'duration', label: 'Duration', align: 'middle', field: 'duration',
          },
          {
            name: 'artist', label: 'Artist', align: 'middle', field: 'artist',
          },
          {
            name: 'album', label: 'Album', align: 'middle', field: 'album',
          },
        ],
      }),
      computed: {
      ...
      methods: {
        playSong: function (props) {
          this.$store.dispatch("musicStore/"+types.music.loadMusic,{artist:props.artist,album:this.songs})
